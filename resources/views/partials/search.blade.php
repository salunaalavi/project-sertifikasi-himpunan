<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" action="/bikes">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <!-- cari data -->
                    <!-- autofocus agar setelah masuk halaman bisa langsung mengetik -->
                    <!-- autocomplete="off" untuk menghapus history pencarian -->
                    <form action="/bikes">
                        @if (request('category'))
                            <input type="hidden" name="category" value="{{ request('category') }}">
                        @endif
                        <input class="form-control me-2 bg-transparent" name="search" size="30" autofocus type="text"
